...
NOPROB1	MOVE.W	(A2)+,D5
	...
	ADD.W	SIN2OFF(PC),A2
	MOVE.W	(A2)+,D5
NOPROBA	ADD.W	D5,D4		; OFFSET IN GRAPHICS
...
NTSC	ds.w 10*221,$0000
	DC.W	$FFE1,$FFFE			; JUMP TO PAL
PAL		ds.w 10*52,$0000

	DC.W	$0100,$0200

ADDRESS	DC.W	$0084,$0000,$0086,$0000 	; RESTART ADDRESS
