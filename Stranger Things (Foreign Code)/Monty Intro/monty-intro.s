...
Robster	incbin	"68k.raw"
Padding	dcb.b	62*(336/8),0
ScrMess	dc.b "               "
	dc.b	"HERE IS A NEW INTRO ADJUSTED FOR THE MODERN "
	dc.b	"VASM ASSEMBLER BY   -  ARKTOS-680XX   - a   "
	dc.b	"FIRST TIME WITH SOUND FROM THE MACHINE! ONE OF "
	dc.b	"MY ALL TIME FAVORITES   - MONTY ON THE RUN HISCORE THEME. "
	dc.b	"COMPOSED BY THE ONE AND ONLY   - ROB HUBBARD! -   a"
	dc.b	"ORIGINAL SOURCECODE BY   - ROBSTER-GEMANIX - a  "
	dc.b 	"CAPTURED ON REAL HARDWARE   - APOLLO A6000 -   a  "
	dc.b 	"GREETINGS FLY TO ALL GUYS ON THE APOLLO DISCORD SERVER!"
	dc.b 	"SOON I WILL RELEASE MY FIRST OWN MINI PRODUCTIONS! "
	dc.b 	"AS ALWAYS: WITH SOURCECODE RELEASE! "
	dc.b 	"GREETINGS FLY TO ALL GUYS ON THE APOLLO DISCORD SERVER! "
	dc.b    "WE ALL KEEP THIS INCREDIBLE MACHINE ALIVE! ",0
	even
;MT_Data	incbin	"mod.TopGlad"
MT_Data	incbin	"montyhig.mod"